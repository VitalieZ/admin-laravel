...
<li class="dd-item" data-id="{{ $item->id}}">
    <div class="dd-handle">
        ...
        <span class="pull-right dd-nodrag">
            ...
            @endif
            <a href="{{ route('menua.show', $item->id) }}"><i class="fas fa-eye"></i></a>
            <a href="{{ route('menua.edit', $item->id) }}" data-id="{{ $item->id}}" class="tree_branch_edit"><i class="fa fa-edit"></i></a>
    ...
    <ol class="dd-list">
        @include('admin::admin.menua.customMenuItems',['items' => $item->cheaild])
    </ol>
    @endif
</li>
@endforeach